...
class TextFormatterTests < Test::Unit::TestCase
  ...
  def test_formatted_lines
    input_string = "This line is pretty long! It's definitly more than 80 characters! I think we should wrap this around to a new line at least once! "
    assert_equal("This line is pretty long! It's definitly more than 80 characters! I think we\nshould wrap this around to a new line at least once!", @formatter.formatted_lines(input_string))

    assert_equal("This is a seccond test. It has some characteristics of the first test but there\nare definitly some differences. For example, we are going to enter a really\nlong word here:\nvqvfqrczgvjrwniaolqltubqhghdfivxvvksgmfqwagovfcxsuepnaoaqznbdicudijspjzjjndrvnjimlndaxrvqj\n(Don't worry, that's a made up word.)", @formatter.formatted_lines("This is a seccond test. It has some characteristics of the first test but there are definitly some differences. For example, we are going to enter a really long word here: vqvfqrczgvjrwniaolqltubqhghdfivxvvksgmfqwagovfcxsuepnaoaqznbdicudijspjzjjndrvnjimlndaxrvqj (Don't worry, that's a made up word.)"))
  end

  def test_margins
    input_string = "This line is pretty long! It's definitly more than 80 characters! I think we should wrap this around to a new line at least once! "
    assert_equal("    This line is pretty long! It's definitly more than 80 characters! I\n    think we should wrap this around to a new line at least once!", @formatter.formatted_lines(input_string, margin: 4))
  end
